...
$testingText = new TextObject ( array (
	'idName' => 'testingText',
	'textBody' => 'Here is some text for testing the capabilities of a text object. Just checking how it might display.')
	);

$authHealthRecs = new QuestionPage ( array (
	'idName' => 'authHealthRecs', 
	'labelText' => 'Authorize access to your health records.', 
	'childElements' => array ( $authRecsSet, $testingText ), 
...
$lwExpirationSet = new QuestionFieldSet ( array (
	'idName' => 'lwExpirationSet', 
	'labelText' => '', 
	'childElements' => array ( $lwExpIndef, $lwExpDate, $lwExpCircum, $lwExpBoth ), 
	'childrenType' => 'radio',
	'required' => 'no')
	);
// ____________ END EXPIRATION CIRCUM FIELDSET
