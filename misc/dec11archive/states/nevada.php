...
$limitations = new QuestionPage ( array (
	'idName' => 'limitations', 
	'labelText' => 'In exercising the authority under this durable power of attorney for health care, the authority of my agent is subject to the following special provisions and limitations:', 
	'childElements' => array ( $freeTextElementSet, $expDateSet ), 
...
$furtherDirect = new QuestionFieldSet ( array (
	'idName' => 'furtherDirect', 
...
$lifeSustainingSet = new QuestionFieldSet ( array (
	...
	'childElements' => array ( $lsNo, $lsNoFT, $lsYes, $furtherDirect ), 
	'childrenType' => 'radio',
	'required' => 'no')
	);
...
$lifeSustaining = new QuestionPage ( array (
	...
	'labelText' => '', 
	'childElements' => array ( $lifeSustainingSet ), 
...
$organDonation = new QuestionPage ( array ( 
	...
	'helpText' => 'You do not have to initial any of the statements. If you do not initial any of the statements, your attorney for health care, proxy, or other agent, or your family, may have the authority to make a gift of all or part of your body under Nevada law.')
	); 
