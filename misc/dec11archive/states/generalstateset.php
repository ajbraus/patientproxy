...
$patientInfo = new QuestionPage ( array (
	'idName' => 'patientInfo', 
	'labelText' => 'Your Personal Informationaut', 
...
$contradict = new SelectionElement ( array (
	'idName' => 'contradict', 
	'labelText' => 'My health proxy should follow what health care instructions I specify in this directive, but may contradict those instructions (life support, artificial nutrition and hydration, etc) upon their own judgement.', 
	'childElements' => array () , 
	'inputType' => 'radio',
	'required' => '',
...
$noContradict = new SelectionElement ( array (
	'idName' => 'noContradict', 
	'labelText' => 'My health proxy should follow what health care instructions I specify in this directive, and may not contradict those instructions (life support, artificial nutrition and hydration, etc).', 
	'childElements' => array () , 
	'inputType' => 'radio',
	'required' => '',
	'validationType' => 'nameVal',
...
$authRecsSet = new QuestionFieldSet ( array (
	'idName' => 'authRecsSet', 
	'labelText' => '', 
	'childElements' => array ( $contradictionSet, $authRecs, $authRecsImmediate ), 
	'childrenType' => 'radio',
	'required' => 'yes')
	);
...
$authHealthRecs = new QuestionPage ( array (
	...
	'labelText' => 'I authorize my health proxy to get access to all my health records', 
...
$orgDonAny = new SelectionElement ( array (
	'idName' => 'orgDonAny', 
	'labelText' => '(a) I give any needed organs, tissues, or parts.', 
	'childElements' => array () , 
	'inputType' => 'radio',
	'required' => '',
	'validationType' => 'nameVal',
...
$orgDonSpecify = new SelectionElement ( array (
	...
	'labelText' => '(b) I give the following organs, tissues, or parts only:', 
	'childElements' => array ( $freeTextSet ) , 
	'inputType' => 'radio',
	'required' => '',
	'validationType' => 'nameVal',
...
$orgDonNone = new SelectionElement ( array (
	'idName' => 'orgDonNone', 
	'labelText' => '(c) I do not give any of my organs, tissues, or parts and do not want my agent, guardian, or family to make a donation on my behalf.', 
	'childElements' => array () , 
	'inputType' => 'radio',
	'required' => '',
	'validationType' => 'nameVal',
